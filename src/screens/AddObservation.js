            ...
            <View style={{ flex: 0.1}}>
                {
                    ...
                    ?  <View style={{ flex: 0.8, marginTop: '5%'}}>
                            <Button containerStyle={{ marginHorizontal: '5%'}}  icon={{ name: 'incognito', type:'material-community', color:'white'}} title="Submit as Anonymous" titleStyle={{ fontSize: 16 }} buttonStyle={{ backgroundColor: '#1e5873', width: '100%'}} onPress={submitFormAnonymously} loading={isButtonAnonymously}/>
                        </View>
                    :  <View style={{ flex: 0.8, marginTop: '5%', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', height:'10%'}}>
                            <Button  title="Submit" titleStyle={{ fontSize: 16 }}  buttonStyle={{ backgroundColor: '#1e5873'}} containerStyle={{ width: '45%'}} onPress={submitForm} loading={isButtonLoading}/>
                            <Button  title="Save & Come Back" titleStyle={{ fontSize: 16 }} buttonStyle={{ backgroundColor: '#1e5873'}} containerStyle={{ width: '45%'}} onPress={saveAndComeBack} loading={isButtonComeBack}/>
                        </View>
                }
            </View>
            {
